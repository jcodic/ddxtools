...
public class Crypt implements Progress {
    ...
    protected final Keys keys = new Keys();
    ...
    private void readFiles(List<File> files) throws Exception {
        ...
        for (File file : files) {
            ...
            if (file.isDirectory()) {
                ...
                Utils.out.println(" [dir] " + file.getPath() + " skip");
                continue;
    ...
    private boolean processRead() throws Exception {
        ...
        Utils.out.println("Read path ["+settings.sourcePath+"]");
    ...
    private static void printInfo() {
        ...
        Utils.out.println( 5, "read - read entire content of specified file_or_directory");
